export const leadTransitions: Record<string, readonly string[]> = {
  ...
  interview_scheduled: ["interview_rescheduled", "interview_completed", "interview_no_show", "selected", "joined", "no_response", "call_back", "not_interested", "not_fit", "long_distance"],
  interview_rescheduled: ["interview_scheduled", "interview_completed", "interview_no_show", "selected", "joined", "no_response", "call_back", "not_interested", "not_fit", "long_distance"],
